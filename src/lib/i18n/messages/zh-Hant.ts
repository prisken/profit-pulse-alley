...
export const zhHantMessages: Messages = {
  ...
  "home.cycleLoop.scoring.participation": "+{points} 參與分",
  "home.cycleLoop.scoring.match": "+{points} 配對獎賞",
  "home.cycleLoop.scoring.streak": "+{points} 連勝獎賞",
  "home.cycleLoop.scoring.note": "配對及連勝獎賞會在 PPA Insight 公布後解鎖。",
