...
export const zhHantMessages: Messages = {
  ...
  "home.hero.subheadline":
    "每天閱讀一則市場訊號，選擇看升或謹慎，並在周期公布後看看你的直覺與 PPA Insight 有何差異。",
  "home.hero.tagline": "閱讀今日訊號，作出判斷，登上排行榜。",
  "home.hero.ctaEnter": "進入 Market Pulse",
  "home.hero.ctaEnterAria": "進入 Market Pulse 主頁",
  "home.hero.ctaPlayToday": "挑戰今日訊號",
  "home.hero.ctaPlayTodayAria": "挑戰今日 Market Pulse 訊號",
  "home.hero.ctaSecondary": "查看規則",
  "home.hero.ctaSecondaryAria": "查看 Market Pulse 規則與計分方式",
  "home.hero.ctaExplore": "探索 Market Pulse",
  "home.hero.ctaPlay": "立即挑戰",
  "home.hero.proof.dailySignals": "每日訊號",
  "home.hero.proof.leaderboard": "每期全新排行榜",
  "home.hero.proof.ppaReveal": "PPA Insight 公布",
  "home.hero.proof.prize": "海洋公園門票獎賞",
  ...
  "home.howItWorks.title": "Market Pulse 怎樣玩",
  "home.howItWorks.stepLabel": "第 {step} 步",
  "home.howItWorks.step1.title": "閱讀訊號",
  "home.howItWorks.step1.body": "每天查閱一張市場卡，掌握作出判斷所需的背景。",
  "home.howItWorks.step2.title": "選擇看升或謹慎",
  "home.howItWorks.step2.body": "在公布窗口前鎖定一次決定，提交後不可更改。",
  "home.howItWorks.step3.title": "公布後學習",
  "home.howItWorks.step3.body":
    "周期結束後，對照 PPA Insight 檢視你的直覺，並查看得分。",
  "home.howItWorks.ctaTry": "試玩挑戰",
  "home.howItWorks.ctaTryAria": "試玩 Market Pulse 挑戰",
  "home.howItWorks.ctaPlayToday": "挑戰今日訊號",
  "home.howItWorks.ctaPlayTodayAria": "挑戰今日 Market Pulse 訊號",

  "home.cycleLoop.badge": "周期排行榜",
  "home.cycleLoop.title": "每期都是全新競賽",
  "home.cycleLoop.subtitle":
    "每個新的 Market Pulse 周期都會重新計分。過往成績會保留在檔案庫，每期都是你再次爭冠的機會。",
  "home.cycleLoop.pillar1.title": "全新排行榜",
  "home.cycleLoop.pillar1.body": "在本期與所有參加者同場競逐。",
  "home.cycleLoop.pillar2.title": "參與分",
  "home.cycleLoop.pillar2.body": "每日出席、鎖定判斷，並追蹤你的進度。",
  "home.cycleLoop.pillar3.title": "周期冠軍獎賞",
  "home.cycleLoop.pillar3.body": "每期冠軍可獲得一張海洋公園門票。",
  "home.cycleLoop.scoring.heading": "得分方式",
  "home.cycleLoop.scoring.participation": "+{points} 訊號卡參與分",
  "home.cycleLoop.scoring.match": "+{points} 訊號配對正確",
  "home.cycleLoop.scoring.streak": "每 {interval} 次連續訊號配對正確 +{points} 連勝加分",
  "home.cycleLoop.scoring.rest": "+{points} 市場休息卡（僅參與分）",
  "home.cycleLoop.scoring.note": "配對及連勝加分僅適用於訊號卡，並於 PPA Insight 公布後解鎖。",
  "home.cycleLoop.preview.heading": "排行榜",
  "home.cycleLoop.preview.label": "預覽",
  "home.cycleLoop.preview.subtitle": "示意排名 — 並非即時分數。",
  "home.cycleLoop.preview.ariaLabel": "周期排行榜預覽示意，分數已隱藏",
  "home.cycleLoop.preview.player1": "預覽 · Alex",
  "home.cycleLoop.preview.player2": "預覽 · Jordan",
  "home.cycleLoop.preview.player3": "預覽 · Sam",
  "home.cycleLoop.preview.scoreHidden": "—",
  "home.cycleLoop.prize.heading": "周期冠軍獎賞",
  "home.cycleLoop.prize.body": "每期冠軍將獲得一張海洋公園門票。",
  "home.cycleLoop.link.leaderboard": "查看排行榜",
  "home.cycleLoop.link.leaderboardAria": "查看 Market Pulse 排行榜",
  "home.cycleLoop.link.rules": "閱讀比賽規則",
  "home.cycleLoop.link.rulesAria": "閱讀 Market Pulse 比賽規則",

  "home.ppaInsight.badge": "PPA Insight",
  "home.ppaInsight.title": "不只是猜測，而是學習循環。",
  "home.ppaInsight.body":
    "每個周期結束後，PPA Insight 會公布市場判斷背後的邏輯。對照你的直覺與專家見解，為下一次決策做好準備。",
  "home.ppaInsight.cta.explore": "探索 Market Pulse",
  "home.ppaInsight.cta.exploreAria": "探索 Market Pulse 主頁",
  ...
  "home.events.eyebrow": "社群與活動",
  "home.events.heading": "排行榜以外，繼續學習",
  "home.events.subtitle":
    "爐邊對談及線下活動，補足你的 Market Pulse 實戰練習——非必須，但值得參與。",
  ...
  "home.philosophy.intro":
    "Profit Pulse Ally 協助創業者與投資者平衡增長、防守與長期複利——Market Pulse 的 PPA Insight 亦源自同一套嚴謹框架。",
  "home.philosophy.pillar.offense.title": "進攻",
  "home.philosophy.pillar.offense.body": "以紀律判斷捕捉動能與增長機會。",
  "home.philosophy.pillar.defense.title": "防守",
  "home.philosophy.pillar.defense.body": "在資金投入前守護現金流並管理風險。",
  "home.philosophy.pillar.compounding.title": "複利",
  "home.philosophy.pillar.compounding.body": "累積可持續疊加的決策，朝零成本人生邁進。",
  ...
  "home.finalCta.heading": "準備好迎接下一則訊號？",
  "home.finalCta.body":
    "免費建立帳戶，儲存你的判斷、追蹤得分，並在每個周期競逐排名。",
  "home.finalCta.member": "免費建立帳戶",
  "home.finalCta.memberAria": "免費建立 Profit Pulse Ally 帳戶",
  "home.finalCta.playGuest": "免註冊試玩",
  "home.finalCta.playGuestAria": "免註冊試玩 Market Pulse",
