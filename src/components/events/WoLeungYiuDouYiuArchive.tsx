...
function PastEventBanner() {
  return (
    <div
      className="border-b border-red-300/40 bg-red-100 px-4 py-3 text-center text-sm font-medium text-red-900 dark:border-red-900/50 dark:bg-red-950/80 dark:text-red-200"
      role="status"
    >
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-50 lg:hidden">
        <div className="pointer-events-auto border-t border-foreground/10 bg-background/95 px-3 py-2.5 pb-[max(0.5rem,env(safe-area-inset-bottom))] shadow-[0_-6px_24px_rgba(0,0,0,0.07)] backdrop-blur-md dark:shadow-[0_-6px_24px_rgba(0,0,0,0.35)]">
          <div className="mx-auto flex max-w-6xl flex-col">
            <span
              className={`${ctaPrimary} min-h-11 cursor-not-allowed opacity-60`}
              aria-disabled="true"
            >
              {CLOSED_CTA_TEXT}
            </span>
