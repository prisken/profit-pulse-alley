...
import { buildAdminMpDashboardBreadcrumbs } from "@/lib/market-pulse/admin-mp-navigation";
    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-50">
      <div className="mx-auto w-full max-w-6xl overflow-x-hidden px-3 py-6 sm:px-6 sm:py-12">
        <header className="border-b border-zinc-800 pb-6">
          <MarketPulseAdminBreadcrumbs items={buildAdminMpDashboardBreadcrumbs()} />
          ...
          <div className="mt-2 flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-relaxed text-zinc-400">
                {t("auth.admin.mp.nav.landingSubtitle")}
              </p>
